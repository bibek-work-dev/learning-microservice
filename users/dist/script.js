...
async function seed() {
    await (0, mongoose_1.connect)("mongodb+srv://root:root@cluster0.8i370yw.mongodb.net/?appName=Cluster0");
    const User = (0, mongoose_1.model)('User', users_schema_1.UserSchema);
